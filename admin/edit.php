...
require_once('session/Login.php'); 
 ...
 $admin = mysqli_fetch_assoc($query);
        ...
        $employee = "SELECT *, employees.id AS empid 
        FROM employees 
        LEFT JOIN position ON position.id=employees.position_id 
        LEFT JOIN barcode ON barcode.employee_id=employees.employee_id 
        LEFT JOIN schedules ON schedules.id=employees.schedule_id 
        WHERE employees.employee_id = '$emid'";
        ...
        <div class="my-3 my-md-5">
          ...
          <div class="container">
            ...
            <div class="page-header">
              <h1 class="page-title">
                <a href="profile.php" class="text-primary">Profiling</a> <i style="font-size: 20px;" class="fa-solid fa-greater-than"></i> Edit Profile
              </h1>
            </div>
