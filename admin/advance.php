...
<html lang="en" dir="ltr">
  ...
  <style>
      ...
      body, h1, h2, h3, h4, h5, h6, p, a, table, tr, th, td, button {
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body  p-lg">
                                     ...
                                     <div class="col-12" style="padding-bottom: 15px;">
                                        <label class="form-label">Cash Amount</label> Php
                                        <input type="number" class="form-control" name="amount" placeholder="Edit cash amount of <?php echo $row['amount'] ?>">
                                      </div>
                                    </div>
