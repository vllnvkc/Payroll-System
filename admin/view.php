    ...
    document.body.innerHTML = oldPage;
          ...
          <div class="container">
            ...
            <div class="page-header">
              <h1 class="page-title">
                <a href="profile.php" class="text-primary">Profiling</a> <i style="font-size: 20px;" class="fa-solid fa-greater-than"></i> Profile
              </h1>
            </div>
            <div class="row row-cards">           
             ...
             <div style="padding-left: 12px; padding-bottom: 25px;">
              ...
              <div style="padding-left: 12px; float: right; padding-bottom: 25px;">
                ...
                <i class="fa-solid fa-id-card-clip"></i> View ID
                </button>
              </div> 
              ...
              <form class="">
                <div class="card-body" id="printDataHolder">
                  ...
                  <div class="row">
                     ...
                     <?php
$edu = "SELECT * FROM `education` WHERE `eid` = '$emid' ORDER BY `id` ASC;";
