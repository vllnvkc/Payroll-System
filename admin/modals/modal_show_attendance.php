...
<div class="table-responsive" id="printDataHolder">
                      <table class="table table-hovered" id="" cellspacing="5">
                        ...
                        <tbody>
                          ...
                          echo !empty($row['time_in_morning']) ? date('h:i A', strtotime($row['time_in_morning'])) : 'N/A'; 
                          ?></td>
                            <td ><a class="text-inherit"><?php 
                        echo !empty($row['time_out_morning']) ? date('h:i A', strtotime($row['time_out_morning'])) : 'N/A'; 
                        ?></td>
                            ...
                            <td >
                            <?php 
                          echo !empty($row['time_in_afternoon']) ? date('h:i A', strtotime($row['time_in_afternoon'])) : 'N/A'; 
                          ?>
                            </td>
                            <td ><?php 
                          echo !empty($row['time_out_afternoon']) ? date('h:i A', strtotime($row['time_out_afternoon'])) : 'N/A'; 
                          ?></td>
