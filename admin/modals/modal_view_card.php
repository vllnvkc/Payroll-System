...
if (isset($_POST['add_deploy'])) {
    ...
    $query = mysqli_query($connection, $insert) or die(mysqli_error($conn) . $insert);
                ...
                <div class="modal-body p-lg" id="printDataHolder3">
                    <div class="col-md-12">
                        <div class="form-group">
                            <center><label style="padding-top: 15px; padding-bottom:1px"  class="form-label"><B>TWENTY-SIXTEEN CONSTRUCTION AND MERCHANDISE</B><p style="padding-top: 0px;" class="-label">San Isidro, Victoria, Oriental Mindoro</p></label></center>
